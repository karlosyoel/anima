<html lang="en"><head>
    ...
    <body wfd-invisible="true">
        <div id="container"><canvas style="width: 741px; height: 703px;" width="926" height="878"></canvas><div style="position: absolute; top: 0px; left: 0px; cursor: pointer; opacity: 0.9; z-index: 10000;"><canvas style="width: 80px; height: 48px; display: block;" width="80" height="48"></canvas><canvas style="width: 80px; height: 48px; display: none;" wfd-invisible="true" width="80" height="48"></canvas></div></div>
		<div id="speedometer">0.5 km/h</div>
        ...
        <!-- <script src="./vendor/mrdoob/three.js/build/three/three.min.js" wfd-invisible="true"></script> -->
        <!-- <script src="./vendor/mrdoob/three.js/examples/jsm/controls/OrbitControls.js" wfd-invisible="true"></script> -->
        <script src="./otros/detector.js" wfd-invisible="true"></script>
        <!-- <script src="../js/three/stats.min.js" wfd-invisible="true"></script> -->
        ...
        <script wfd-invisible="true" type="module">
